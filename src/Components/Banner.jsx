        ...
        <Container>
            <Row className='align-items-center'>
                <Col xs={12} md={6} xl={7}>
                    ...
                    <h1>{`Hi there, I'm Mithalesh `} <br></br> <span className='wrap'>{text}</span></h1>
                    <p>currently pursuing B.Tech in Computer Science, with one year of hands-on experience in web development. My expertise spans C++, Python, and JavaScript, and I’ve successfully completed a range of projects, from small-scale applications to more complex, moderately scaled solutions. My portfolio reflects my ability to build scalable, high-performance web applications, and I take pride in writing clean, efficient code that meets industry standards.</p>
